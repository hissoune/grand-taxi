...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-500 antialiased">
        ...
        <div class="min-h-screen flex flex-col my-6 sm:justify-center items-center pt-6 sm:pt-0 bg-gray-500">
            <div>
                <a href="/">
            ...
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-gray-100 mt-6  shadow-md overflow-hidden sm:rounded-lg">
                {{ $slot }}
            </div>
            <footer>
